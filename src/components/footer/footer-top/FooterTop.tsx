...
import ListLink from '@components/footer/footer-top/list-links/ListLink';
import ListLinks from '@components/footer/footer-top/list-links/ListLinks';
import SocialItems from '@components/footer/footer-top/SocialItems';
        ...
        <div className="flex justify-between">
          ...
          <ListLinks title="CONTACT US">
            <li className="flex gap-2 items-center group/link">
              ...
              <a
                className="group-hover/link:underline group-hover/link:text-white duration-300"
              ...
              <div className="flex flex-col gap-3">
                <form>
                  <label className="relative" htmlFor="footer-input">
                    <input
                      className="py-2.5 pl-3 pr-8 border-solid border-2 border-[rgba(255,255,255,0.2)] rounded bg-[rgba(255,255,255,0.12)] w-full placeholder:text-sublink placeholder:text-xs focus:border-gray-300 duration-300 text-white text-sm"
                      type="email"
                      id="footer-input"
                      placeholder="Email address"
                    />
                    <button type="submit" className="absolute top-[calc(50%-8px)] right-4 group/icon">
                      <MoveRight
                        className="group-hover/icon:text-white duration-300 group-hover/icon:scale-120"
                        size={16}
                      />
                    </button>
                  </label>
