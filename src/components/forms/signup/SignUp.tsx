...
import UICheckbox from '@/UI/form/checkbox/UICheckbox';
import UIInput from '@/UI/form/input/UIInput';
import UILabel from '@/UI/form/label/UILabel';
import { ISignUpFormInput } from '@/types/form/form.types';
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
      ...
      <div>
        ...
        <UIInput
          ...
          errors={errors}
          nameInput="email"
          placeholderText="Your working email"
          typeInput="email"
          isRequired={true}
        />
      </div>
      <div>
        ...
        <UIInput
          ...
          errors={errors}
          nameInput="password"
          placeholderText="Your working password"
          typeInput="password"
          isRequired={true}
        />
      </div>
      <div>
        ...
        <UIInput
          register={register}
          errors={errors}
          nameInput="confPassword"
          placeholderText="Your confirm password"
          typeInput="password"
          isRequired={true}
        />
      </div>
